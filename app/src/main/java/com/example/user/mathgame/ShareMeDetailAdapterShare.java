 ...
 */
public class ShareMeDetailAdapterShare extends BaseRecyclerShareViewAdapter<ShareMeDetailAdapterShare.ViewHolder> {
    Context mContext;
    private List<ShareReceiveBean.DataBean.GivesBean.DevicesBeanX> mDevices;

    public ShareMeDetailAdapterShare(Context context, List<ShareReceiveBean.DataBean.GivesBean.DevicesBeanX> devices) {
        mContext = context;
        mDevices = devices;
    }
