...
public class OnlineDeviceListAdapter extends BaseRecyclerViewAdapter<OnlineDeviceListAdapter.ViewHolder> {
    List<ShareBean> mDevices;
    Context mContext;

    public OnlineDeviceListAdapter(Context context, List<ShareBean> devices) {
        mContext = context;
        mDevices = devices;
    }

    public void resetDevices(List<ShareBean>devices) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.cb_client.setChecked(mDevices.get(position).isChecked());
